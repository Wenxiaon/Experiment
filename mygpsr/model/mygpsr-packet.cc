...
#include "mygpsr-packet.h"
#include "ns3/address-utils.h"
#include "ns3/packet.h"
#include "ns3/log.h"

NS_LOG_COMPONENT_DEFINE ("MyGpsrPacket");
...
TypeHeader::TypeHeader (MessageType t = MYGPSRTYPE_HELLO)
  : m_type (t),
    m_valid (true)
{
}
...
{
  static TypeId tid = TypeId ("ns3::mygpsr::TypeHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mygpsr::HelloHeader")
    .SetParent<Header> ()
...
{
  static TypeId tid = TypeId ("ns3::mygpsr::PositionHeader")
    .SetParent<Header> ()
