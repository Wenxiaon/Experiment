...
#ifndef MYGPSR_RQUEUE_H
#define MYGPSR_RQUEUE_H
...
/**
 * \ingroup mygpsr
 * \brief MYGPSR route request queue
 *
 * Since MYGPSR is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
