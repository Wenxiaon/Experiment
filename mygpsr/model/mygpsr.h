 ...
 * \ingroup mygpsr
 *
 * \brief MYGPSR routing protocol
 */
class RoutingProtocol : public Ipv4RoutingProtocol
{
public:
  static TypeId GetTypeId (void);
  static const uint32_t MYGPSR_PORT;
  ...
  virtual void RecvMYGPSR (Ptr<Socket> socket);
